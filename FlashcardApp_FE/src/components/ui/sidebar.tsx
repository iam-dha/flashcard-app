    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          className="frosted-glass text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden" // modified
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="frosted-glass group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm" // modified
        >
          {children}
        </div>
      </div>
